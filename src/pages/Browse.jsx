...
export default function Browse() {
  ...
  const [liveOnly] = useState(false);
  const [sortBy] = useState('viewers');
    ...
    <>
      ...
      <div className={`search-container ${searchFocused ? 'search-focused' : ''}`}>
        <div className="search-bar-row">
          ...
          />
          {searchFocused && (
            <button className="search-cancel" onClick={(e) => {
              e.stopPropagation();
              setSearchFocused(false);
              setShowSearchResults(false);
              setSearchQuery('');
            ...
            {searchResultsData.states.length > 0 && (
              <>
                ...
                {searchResultsData.states.map(s => (
                  <div key={s.abbr} className="search-item" onClick={() => { openState(s.abbr); setShowSearchResults(false); setSearchFocused(false); }}>
            ...
            {searchResultsData.clubs.length > 0 && (
              <>
                ...
                {searchResultsData.clubs.map((cl, i) => (
                  <div key={i} className="search-item" onClick={() => { openClub(cl.name, cl.state); setShowSearchResults(false); setSearchFocused(false); }}>
